...
def procesamiento_remoto(name, flags, client_local, client_remoto):
    ...
    while flags["thread_continue"]:
        ...
        if topico == "dashboardiot/pablo_pochettino/keepalive/request":
            client_remoto.publish("dashboardiot/pablo_pochettino/keepalive/ack", 1)
        else:
            client_remoto.publish("dashboardiot/pablo_pochettino/keepalive/ack", 0)
